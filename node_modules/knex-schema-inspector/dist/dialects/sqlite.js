        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        columns = _a.sent();
                        return [2 /*return*/, columns.map(function (column) { return ({ table: table, column: column.name }); })];
                ...
                switch (_a.label) {
                    case 0:
                        getColumnsForTable = function (table) { return __awaiter(_this, void 0, void 0, function () {
                            var tablesWithAutoIncrementPrimaryKeys, columns, foreignKeys;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.knex
                                            .select('name')
