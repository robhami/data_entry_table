...
describe('postgres-no-search-path', function () {
    var database;
    var inspector;
    before(function () {
    ...
    describe('.columns', function () {
        it('returns information for all tables', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        database.transaction(function (trx) { return __awaiter(void 0, void 0, void 0, function () {
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _a = chai_1.expect;
                                        return [4 /*yield*/, lib_1.default(trx).columns()];
                                    case 1:
                                        _a.apply(void 0, [_b.sent()]).to.deep.equal([
        ...
        it('returns information for a specific column in a specific table', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = chai_1.expect;
                        return [4 /*yield*/, inspector.columnInfo('teams', 'name')];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).to.deep.equal({
                            schema: 'public',
                            name: 'name',
    ...
    describe('.transaction', function () {
        it('works with transactions transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                database.transaction(function (trx) { return __awaiter(void 0, void 0, void 0, function () {
                    var _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _a = chai_1.expect;
                                return [4 /*yield*/, lib_1.default(trx).primary('teams')];
                            case 1:
                                _a.apply(void 0, [_b.sent()]).to.equal('id');
                                return [2 /*return*/];
                        }
                    });
                }); });
...
describe('postgres-with-search-path', function () {
    var database;
    var inspector;
    before(function () {
        database = knex_1.default({
        ...
        it('returns primary key for a table', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = chai_1.expect;
                        return [4 /*yield*/, inspector.primary('test')];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).to.equal('id');
                        return [2 /*return*/];
                }
                ...
                database.transaction(function (trx) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _a = chai_1.expect;
                                return [4 /*yield*/, lib_1.default(trx).primary('test')];
                            case 1:
                                _a.apply(void 0, [_b.sent()]).to.equal('id');
                                return [2 /*return*/];
                        }
